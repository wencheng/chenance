...
//		registerColumnType(java.sql.Types.TIMESTAMP, "DATETIME");
		...
		registerHibernateType(java.sql.Types.NULL, "NULL");
...
//		return
//			new StringBuffer(insertString.length()+30). // As specify in NHibernate	dialect
//			append(insertString).
